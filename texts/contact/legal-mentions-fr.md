...
Pour les Données Personnelles collectées dans le cadre de la création du compte personnel de l’Utilisateur et de sa navigation sur le Site, le responsable du traitement des Données Personnelles est : multi SAS https://multi.coop représenté par Johan Richer, son représentant légal
